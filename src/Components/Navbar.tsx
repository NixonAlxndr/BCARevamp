    ...
    return (
        <div className="navbar border-b-2 border-black">
            <div className="inner-navbar max-w-[1440px] mx-auto flex items-center justify-between">
                ...
                <div className="option list-none flex gap-4">
                ...
                <div className="add-ons-option flex items-center gap-4">
                    <div className="language font-bold ">
                        <span className="list-anim" style={{"--color":'black'} as  React.CSSProperties}>EN</span>
